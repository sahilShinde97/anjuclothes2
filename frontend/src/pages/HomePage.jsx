...
function HomePage() {
  ...
  usePageMeta({
    title: 'ANJU CLOTHES | Women Fashion Store',
    description: 'Mobile-friendly women fashion store with direct checkout, category filters, product pages, and WhatsApp support.',
          ...
          <div className="p-5 sm:p-7">
            <span className="inline-flex rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[11px] uppercase tracking-[0.22em] text-gold">
              ...
              <h1 className="mt-4 max-w-lg font-heading text-4xl leading-none text-white sm:text-5xl lg:text-6xl">
                Shop elegant looks with direct store checkout.
            </h1>
            <p className="mt-4 max-w-md text-sm leading-6 text-white/65 sm:text-base">
              Explore stylish products in a clean, simple, and mobile-friendly shopping experience.
            </p>
      ...
      <section id="products" className="space-y-4">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="mt-1 font-heading text-3xl text-white sm:text-4xl">Latest collection</h2>
          </div>
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 gap-4 min-[430px]:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
               {products.filter((product) => product.category !== 'Saree' && product.stock > 0).map((product) => (
